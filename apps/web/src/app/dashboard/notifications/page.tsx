      ...
      <div className="bg-white rounded-xl border border-gray-100 divide-y">
        {loading ? (
          ...
          notifications.map((n) => (
            <div 
              key={n.id} 
              className={`p-4 flex items-start gap-4 transition-colors ${n.read ? 'opacity-60' : 'bg-primary-50/10'}`}
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                {!n.read && (
                  <button 
                    ...
                    className="mt-2 text-[10px] font-bold text-primary-500 hover:underline"
                  >
                    MARCAR COMO LEÍDA
                  </button>
                )}
