...
export default function UploadPage() {
  ...
  useEffect(() => { api.get('/templates').then(r => { console.log('Templates cargados:', r.data.length); setTemplates(r.data); }).catch(e => console.error('Error cargando templates:', e?.response?.status, e?.message)); }, []);
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <p className="text-sm text-gray-500 mb-6">Sube tu documento Word o PDF para análisis automático</p>
